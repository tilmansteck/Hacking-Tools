...
threads = 5
resume_word = None
username = input("[*] Enter website username (admin, root): ")
headers = {}
target_url = input("[*] Enter TARGET url: ")
post_url = input("[*] Enter POST url: ")
username_field = input("[*] Enter html id from username field: ")
password_field = input("[*] Enter html id from password field: ")
file_passwdlist = input("[*] Enter path to password list (wordlist.txt): ")
...
passwd_q = build_passwd_q(file_passwdlist)
